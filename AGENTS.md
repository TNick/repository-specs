...
Run `python scripts/validate_catalog.py` before committing. Do not place local
filesystem paths, credentials, generated build output, or project-specific
secrets in this public repository.
